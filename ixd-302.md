...
- Why would customers want this, whats your customer's problem
- what benefits does it offer
- testimonials, gives the product credibility from people who are respected on the topic. 
- Product storytelling. storytelling, especcially online is essential. there is a hunger for brands with a story.

### share your products backstory
- customers are hungry for meaning, provenance and backstory. 
- theyre eager to look behind the curtain and see process.
...
### the language used when selling the product matters. 
- Jeans cs an investment 
- denim cs 100% indigio dyed. 
- Specifications and backstory. 
- blok knives.

### Video paints a picture
- showing video of the product being made and it being put on social media raises the standard. 

### Start thinking about marketing.
- Content, medium, email newsletter, twitter. 
- a newsletter could be helpful to target content to the customer, you can follow up and target them.
...
### whats your niche 
- consider content that meets that niche's needs. 
- interviews. 
- golf course reviews. 
- free guides.

Start working on the web page.
html no CSS yet, work on the storytelling 
...
### 
- first name, if you send an email to the first name it seems more personal. 
- email address, it is useful to build a loyal 

### things to learn from.
- pricing anchors, sets the point to which the rest of the prices look a lot better. 

### What I need
- Low commision
- Ability to bundle products 
- Gathering emails, email > mailchimp
- 30 products
- Student dashboard
- communtity, form Slack

##### Consider 
- whats the average sellig price for what you're offering?
- how do they price their products?
- what will the market bear 
- Consider atomised content

### priorities
- start thinking about the website a bit more
- hand-in 8th of January, presenting 